...
export const EventsIcon = ({ active, inactiveColor = '#78716C' }: { active: boolean; inactiveColor?: string }) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="12" cy="15" r="2" fill={active ? "url(#evi)" : inactiveColor} />
  </svg>
);
...
export const GearIcon = ({ color = '#78716C' }: { color?: string }) => (
...
export const SearchIcon = ({ color = '#78716C' }: { color?: string }) => (
...
export const ShieldIcon = ({ color = '#78716C' }: { color?: string }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
