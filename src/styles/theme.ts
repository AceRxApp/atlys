...
export const lightTheme: ThemeTokens = {
  ...
  bg: {
    body: '#F0EEEC',
    bodyGradient: 'linear-gradient(180deg, #F0EEEC 0%, #EBEAE8 100%)',
    surface: '#F7F6F4',
    surfaceAlpha: 'rgba(247, 246, 244, 0.88)',
    elevated: '#EBEAE8',
    nav: 'rgba(240,238,236,0.95)',
    toast: 'rgba(240,238,236,0.95)',
    input: '#F7F6F4',
    ...
    imageOverlay: 'rgba(240,238,236,0.88)',
