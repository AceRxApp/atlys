...
export const sunsetTheme: ThemeTokens = {
  mode: 'sunset',
  mapColorScheme: 'LIGHT',
  // Warm golden-hour glow — pretty peach & cream like real sunset light
  bg: {
    body: '#F8EDE0',
    bodyGradient: 'linear-gradient(180deg, #FBF0E4 0%, #F0DFCE 100%)',
    surface: '#FFF5EB',
    surfaceAlpha: 'rgba(255, 245, 235, 0.92)',
    elevated: '#F0DECE',
    nav: 'rgba(248, 237, 224, 0.97)',
    toast: 'rgba(248, 237, 224, 0.97)',
    input: '#FFF5EB',
    modalOverlay: 'rgba(60, 30, 15, 0.45)',
    modalOverlayDeep: 'rgba(60, 30, 15, 0.55)',
    subtle: 'rgba(180, 100, 40, 0.05)',
    subtleMedium: 'rgba(180, 100, 40, 0.07)',
    subtleStrong: 'rgba(180, 100, 40, 0.09)',
    subtleButton: 'rgba(180, 100, 40, 0.1)',
    imageOverlay: 'rgba(248, 237, 224, 0.9)',
    photoButton: 'rgba(80, 40, 20, 0.3)',
    photoCounter: 'rgba(80, 40, 20, 0.25)',
  },
  // Warm brown text on golden background
  text: {
    primary: '#3D2218',
    secondary: '#7A5040',
    tertiary: '#A07868',
  ...
  accent: {
    ...
    amberDark: '#D05818',
    amberLight: '#F08838',
    amberGradient: 'linear-gradient(135deg, #E87020, #D05818)',
    amberTextGradient: 'linear-gradient(135deg, #F08838, #E87020)',
  },
  status: {
    green: '#2DAF6E',
    red: '#E05050',
  ...
  selection: {
    bg: 'rgba(232, 112, 32, 0.2)',
  },
  // Warm golden borders
  border: {
    subtle: 'rgba(160, 80, 40, 0.1)',
    medium: 'rgba(160, 80, 40, 0.15)',
    strong: 'rgba(160, 80, 40, 0.2)',
    dashed: 'rgba(160, 80, 40, 0.2)',
    nav: 'rgba(160, 80, 40, 0.1)',
  },
  // Sunset orange tints
  amberTint: {
    bg06: 'rgba(232, 112, 32, 0.06)',
    bg10: 'rgba(232, 112, 32, 0.1)',
    bg15: 'rgba(232, 112, 32, 0.14)',
    border15: 'rgba(232, 112, 32, 0.18)',
    border20: 'rgba(232, 112, 32, 0.22)',
    border30: 'rgba(232, 112, 32, 0.3)',
    border40: 'rgba(232, 112, 32, 0.4)',
    shadow: 'rgba(232, 112, 32, 0.2)',
  },
  greenTint: {
    bg: 'rgba(45, 175, 110, 0.08)',
    bgStrong: 'rgba(45, 175, 110, 0.14)',
    border: 'rgba(45, 175, 110, 0.2)',
    borderStrong: 'rgba(45, 175, 110, 0.28)',
  },
  redTint: {
    bg: 'rgba(224, 80, 80, 0.08)',
    border: 'rgba(224, 80, 80, 0.18)',
    borderStrong: 'rgba(224, 80, 80, 0.25)',
  },
  blueTint: {
    bg: 'rgba(80, 144, 208, 0.08)',
    border: 'rgba(80, 144, 208, 0.16)',
  },
  // Warm coral tints
  purpleTint: {
    text: '#C06050',
    bg08: 'rgba(192, 96, 80, 0.07)',
    bg12: 'rgba(192, 96, 80, 0.1)',
    bg15: 'rgba(192, 96, 80, 0.13)',
    bg20: 'rgba(192, 96, 80, 0.17)',
    border15: 'rgba(192, 96, 80, 0.15)',
    border20: 'rgba(192, 96, 80, 0.2)',
    border30: 'rgba(192, 96, 80, 0.28)',
  },
  communityTint: {
    bg: 'rgba(192, 112, 64, 0.08)',
    bg12: 'rgba(192, 112, 64, 0.12)',
    border: 'rgba(192, 112, 64, 0.18)',
    border40: 'rgba(192, 112, 64, 0.4)',
  },
  skeleton: {
    bg: 'rgba(160, 80, 40, 0.06)',
    shimmer: 'rgba(160, 80, 40, 0.1)',
  },
  scrollbar: {
    track: '#F0DECE',
    thumb: '#C4A090',
